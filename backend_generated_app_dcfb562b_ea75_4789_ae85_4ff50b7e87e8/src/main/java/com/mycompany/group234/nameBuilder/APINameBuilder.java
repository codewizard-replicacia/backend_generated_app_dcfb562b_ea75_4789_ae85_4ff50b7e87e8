...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "Vet_Visit_History".equals(entityTypeName) ? "Vet_Visit_Historys" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "Pet_Info".equals(entityTypeName) ? "Pet_Infos" : defaultNameBuilder.buildEntitySetName(entityTypeName);
        return eSetName;
    }
